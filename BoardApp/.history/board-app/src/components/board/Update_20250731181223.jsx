...
const Update = ({board, fileList, onUpdate, onDelete, onDownload}) => {
  ...
  const handleCheckedFileDelete = () => {
    const check = window.confirm('선택한 ${fileIdList.length}정말 삭제하시겠습니까?)
    if (check) {
      onDelete(id)
    }
  }
    ...
    <div className="container">
                ...
                fileList.map((file) => (
                  <div className='flex-box' key={file.id}>
                    ...
                    <div className="item">
                      ...
                      <button className='btn' onClick={() => handleCheckedFileDelete(file.id)}>
                        삭제
                        </button>
                    </div>
                  </div>
      ...
      <div className="btn-box">
        <div>
          ...
          <button className='btn' onClick={handleCheckFileDelete}>선택 삭제</button>
        </div>
        <div>
