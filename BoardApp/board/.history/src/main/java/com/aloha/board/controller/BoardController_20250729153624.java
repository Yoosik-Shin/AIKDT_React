...
public class BoardController {
    ...
    @PostMapping()
    public ResponseEntity<?> create(@RequestBody Boards todo) {
        try {
            boolean result = boardService.insert(todo);
            if (result)
    ...
    @PutMapping()
    public ResponseEntity<?> update(@RequestBody Boards todo) {
        try {
            boolean result = boardService.updateById(todo);
            if (result)
